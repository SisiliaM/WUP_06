...
```
 ...
 Looking at the fisherXY test it tells us that when comparing the black race to the whites and other races that there is a difference since their p values are lower than 1. However when you compare the white race to the other races it shows us that there is not a difference since the p value is at 1. 
